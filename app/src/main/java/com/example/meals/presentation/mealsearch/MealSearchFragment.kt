...
import com.example.meals.databinding.FragmentMealSearchBinding
import com.example.meals.presentation.adapter.MealAdapter
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class MealSearchFragment : Fragment() {

    private val searchAdapter = MealAdapter()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        searchAdapter.itemClickListener {
            findNavController().navigate(
                MealSearchFragmentDirections.actionMealSearchFragmentToMealDetailsFragment(it.idMeal)
